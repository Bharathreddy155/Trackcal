      ...
      <div className="glass-panel p-6 rounded-3xl border border-slate-800 space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-4 bg-slate-950/80 rounded-2xl border border-slate-800">
            <span className="text-xs text-slate-400 font-medium block">Avg Protein</span>
            <div className="text-2xl font-black text-emerald-400 font-mono mt-1">
              {avgProtein} <span className="text-xs text-slate-400">g / day</span>
            </div>
            <span className="text-[11px] text-slate-500 font-mono">Target: {targets.protein || 105}g</span>
          </div>

          <div className="p-4 bg-slate-950/80 rounded-2xl border border-slate-800">
            <span className="text-xs text-slate-400 font-medium block">Avg Carbs</span>
            <div className="text-2xl font-black text-cyan-400 font-mono mt-1">
              {avgCarbs} <span className="text-xs text-slate-400">g / day</span>
            </div>
            <span className="text-[11px] text-slate-500 font-mono">Target: {targets.carbs || 395}g</span>
          </div>

          <div className="p-4 bg-slate-950/80 rounded-2xl border border-slate-800">
            <span className="text-xs text-slate-400 font-medium block">Avg Fat</span>
            <div className="text-2xl font-black text-amber-400 font-mono mt-1">
              {avgFat} <span className="text-xs text-slate-400">g / day</span>
            </div>
            <span className="text-[11px] text-slate-500 font-mono">Target: {targets.fat || 77}g</span>
          </div>

          <div className="p-4 bg-slate-950/80 rounded-2xl border border-slate-800">
            <span className="text-xs text-slate-400 font-medium block">Avg Fiber</span>
            ...
            <span className="text-[11px] text-slate-500 font-mono">Target: {targets.fiber || 33}g</span>
          </div>
        </div>
      </div>
        ...
        <div className="glass-panel p-5 rounded-2xl border border-slate-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xl font-black text-white font-mono">{workoutCount} / 4 <span className="text-xs text-slate-400 font-normal font-sans">completed</span></div>
            </div>
          </div>
        </div>
        ...
        <div className="glass-panel p-5 rounded-2xl border border-slate-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xl font-black text-white font-mono">{wheyCount} / 7 <span className="text-xs text-slate-400 font-normal font-sans">days</span></div>
            </div>
          </div>
        </div>
        ...
        <div className="glass-panel p-5 rounded-2xl border border-slate-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xl font-black text-white font-mono">{creatineCount} / 7 <span className="text-xs text-slate-400 font-normal font-sans">days</span></div>
            </div>
          </div>
        </div>
