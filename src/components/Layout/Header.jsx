  ...
  return (
    <header className="sticky top-0 z-20 glass-header px-4 py-4 md:px-8">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {/* Right Controls: Date Picker + Day Type Toggle + Single Theme Button */}
        <div className="flex flex-wrap items-center gap-3">
          
          {/* Single Theme Toggle Button (Showing Current Active Mode) */}
          <button
            onClick={toggleTheme}
            className="flex items-center gap-2 px-3.5 py-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-xs font-bold text-slate-800 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 shadow-sm transition active:scale-95 cursor-pointer"
