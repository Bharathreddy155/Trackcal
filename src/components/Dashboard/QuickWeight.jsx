...
export default function QuickWeight() {
  ...
  return (
    <div className="glass-panel p-5 rounded-2xl border border-slate-800 flex flex-col md:flex-row items-center justify-between gap-5">
      
      {/* Left Info */}
      <div className="flex items-center gap-3.5 w-full md:w-auto">
        <div className="w-12 h-12 rounded-xl bg-violet-950/80 text-violet-400 border border-violet-500/30 flex items-center justify-center text-xl shrink-0">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-violet-400 font-mono">{percentage}% Goal Achieved</span>
          </div>

          <div className="flex items-center gap-2 mt-0.5">
            <span className="text-2xl font-black text-white font-mono">{currentWeight} <span className="text-xs text-slate-400">kg</span></span>
            <ArrowRight className="w-4 h-4 text-slate-500" />
            <span className="text-base font-bold text-emerald-400 font-mono">{goalWeight} <span className="text-xs text-slate-400">kg</span></span>
          </div>
      ...
      <form onSubmit={handleSubmit} className="flex items-center gap-2 w-full md:w-auto">
        <div className="relative">
          <input
            ...
            className="w-24 px-3 py-2 bg-slate-900 border border-slate-800 rounded-xl text-white font-mono font-bold text-sm focus:outline-none focus:border-violet-500"
            placeholder="57.5"
          />
        ...
        <button
          type="submit"
          className="px-4 py-2 bg-violet-600 hover:bg-violet-500 text-white text-xs font-bold rounded-xl transition shadow"
        >
          Update Weight
        </button>
      </form>
